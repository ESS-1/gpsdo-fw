...
extern const uint16_t icon_menu_14x16[];
extern const uint16_t icon_save_15x16[];
extern const uint16_t icon_save_inactive_15x16[];
extern const uint16_t icon_back_15x16[];
extern const uint16_t icon_status_ok_15x12[];
extern const uint16_t icon_status_ok_warmup_15x12[];
extern const uint16_t icon_status_err_15x12[];
extern const uint16_t icon_status_err_warmup_15x12[];
extern const uint16_t icon_out_2ma_7x10[];
extern const uint16_t icon_out_4ma_7x10[];
extern const uint16_t icon_out_6ma_7x10[];
extern const uint16_t icon_out_8ma_7x10[];
...
extern const uint16_t image_world_map_width;
extern const uint16_t image_world_map_height;
extern const uint16_t image_world_map_160x80[];
